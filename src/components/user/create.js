            ...
            <div className="cadastroUsuario">                
                <div className="row">
                    ...
                    <div className="form-input">
                        <input disabled={isSubmit} className="campo" type="text" name="nome" label="Nome:" onChange={handleChange} value={form.nome || ""} placeholder="Insira o nome do usuário" autoComplete="false"/>
                    </div>
                </div>
                <div className="row">
                    <div className="etiqueta">
                    ...
                    <div className="form-input">
                        <input disabled={isSubmit} className="campo" type="email" name="email" onChange={handleChange} value={form.email || ""} placeholder="Insira o e-mail do usuário" autoComplete="false"/>
                    </div> 
                </div>
                <div className="row">
                    <div className="etiqueta">
